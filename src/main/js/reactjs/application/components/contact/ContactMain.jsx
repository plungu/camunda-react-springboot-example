...
const TenantList = require('src/main/js/reactjs/renewals/components/tenant/TenantList.jsx');
const TenantDetail = require('src/main/js/reactjs/renewals/components/tenant/TenantDetail.jsx');
